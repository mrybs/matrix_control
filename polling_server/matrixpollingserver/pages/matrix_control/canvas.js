...
let iconbtn_enabled_color = document.getElementById('iconbtn_enabled_color').style.background;
let iconbtn_disabled_color = document.getElementById('iconbtn_disabled_color').style.background;
